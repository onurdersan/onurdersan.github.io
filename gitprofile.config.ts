    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ["onurdersan/micronutrient", "onurdersan/onurdersan.github.io"], // These projects will not be displayed. example: ['arifszn/my-project1', 'arifszn/my-project2']
        },
      },
      manual: {
