...
import scholarData from '../../data/scholar.json'; // Veriyi direkt dosyadan import ediyoruz

// Interface'i config dosyasına taşıyabilir veya burada tutabiliriz
...
const ScholarCard = () => {
  const articles: ScholarArticle[] = scholarData.articles;

  if (articles.length === 0) {
    return null; // Eğer hiç makale yoksa bu bölümü hiç gösterme
  }
